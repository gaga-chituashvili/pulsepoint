...
const Header = () => {
  return (
    <header className="relative [@media(max-width:1010px)]:h-[1032px]">
      ...
      <img
        className="w-full h-full object-cover [@media(max-width:481px)]:hidden"
        src={cover}
        alt="cover"
      />
      <img
        className="hidden w-full h-full object-cover [@media(max-width:481px)]:block"
        src={cover2}
        alt="cover"
      />
      ...
      <section className="flex flex-col items-center absolute left-1/2 bottom-[32px] -translate-x-1/2 text-white text-center space-y-4 px-4 w-full max-w-[90%]">
        <h2 className="text-[#CAAB72] text-[40px] [@media(max-width:1010px)]:text-[32px] [@media(max-width:731px)]:text-[24px]">
          celebrate SPORTSbook 300% bonus
        </h2>
        <p className="whitespace-pre-line text-[24px] [@media(max-width:1010px)]:text-[20px] [@media(max-width:731px)]:text-[16px]">
